...
**Core problem**
Photographers want to credit wedding suppliers accurately on Instagram and via email, but supplier details are scattered, incomplete, and manually collected.

**Product promise (MVP)**

> *Send one link. Get wedding supplier credits back — copy-ready and formatted for Instagram.*
...
It is used by suppliers (usually wedding photographers) to create and management events in order to gather supplier credits from couples.
...
This flow has **two navigation views (supplier list + create new supplier)** with **multiple UI states**. It is used by couples to list the suppliers they used for their wedding so they can be eaily credited.
...
* Explains:
  ...
  * That this helps credits & thank-yous
* Reassurance:
