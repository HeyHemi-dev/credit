...
- Steps:
    1. See short explanation of why you need this (credits + thank you’s).
...
- Success: Enough detail captured to produce “copy-ready” credits.
...
## Photographer reviews + copies IG-formatted credits
...
- Success: Credits paste cleanly with correct @handles and consistent ordering.
- Edge cases:
...
- Steps:
    ...
    7. Submit.
    8. System does a **“Did you mean one of these?”** check (support-form style) *before* creating:
...
- Success: Couple can keep moving without friction, and the event still gets copy-ready credits.
