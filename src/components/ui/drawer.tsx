  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        ...
        'bg-primary/10 backdrop-contrast-50 fixed inset-0 z-50',
        className,
      )}
      {...props}
    />
