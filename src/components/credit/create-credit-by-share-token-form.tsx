...
import { requireShareAuth } from '@/hooks/use-auth'
...
export function CreateCreditByShareTokenForm({
  onSubmit,
  onCancel,
  containerRef,
}: {
  ...
  const { createCreditMutation } = useCreditsByShareToken(
    shareAuth.token,
    shareAuth,
  )
  ...
  return (
    <form
      id="create-event-credit-by-share-token-form"
      onSubmit={(e) => {
        e.preventDefault()
        form.handleSubmit()
      }}
    ...
    >
      ...
      <div className="flex justify-end gap-2">
        ...
        <Button
          type="submit"
          form="create-event-credit-by-share-token-form"
          disabled={form.state.isSubmitting}
        >
          Save
        </Button>
